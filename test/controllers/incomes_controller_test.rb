...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { description: @income.description, total: @income.total } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { description: @income.description, total: @income.total } }
