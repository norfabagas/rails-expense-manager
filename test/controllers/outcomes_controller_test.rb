...
class OutcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outcome" do
    assert_difference('Outcome.count') do
      post outcomes_url, params: { outcome: { description: @outcome.description, total: @outcome.total } }
    end
  ...
  test "should update outcome" do
    patch outcome_url(@outcome), params: { outcome: { description: @outcome.description, total: @outcome.total } }
